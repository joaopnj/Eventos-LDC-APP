...
public class EventListFragment extends ListFragment {
     ...
     * clicks.
     */
    private Callbacks mCallbacks = sEventCallbacks;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final String URL = "http://localhost:3000/indexEvento";
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String res) {
                ArrayList<EventContent.Event> events = WebConsumer.serializeJSONRequest(res);

                setListAdapter( new ArrayAdapter<EventContent.Event>(getActivity(),
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(EventContent.events.get(position).id);
    }
